...
export function DriveToday() {
  return (
    <div className="p-6 lg:my-32 max-w-7xl mx-auto">
      <div className="bg-[url('/images/background.png')] bg-center bg-no-repeat bg-cover rounded-xl p-6 lg:p-32 relative">
        <div className="lg:flex gap-x-6 ">
          ...
          <Reveal className="lg:absolute lg:right-0 top-5" position="bottom">
            <Image
              src="/images/bmw_x6.png"
              alt="Car Drive"
              width={550}
              height={250}
            />
